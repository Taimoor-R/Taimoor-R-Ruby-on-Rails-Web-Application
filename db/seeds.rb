...
Product.create([
  ...
  p "Created #{Product.count} Product Entries." # PRINT ON CONSOLE NUMBER OF ENTRIES CREATED FOR PRODUCTS
  p "Created #{User.count} User Entries." # PRINT ON CONSOLE NUMBER OF ENTRIES CREATED FOR PRODUCTS
